                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body-min">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <img class="center-block img-responsive" src="{{ asset('/images/graficos/popularidad_campeones.png') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body-min">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table id="ordenar" width="60%" class="table table-hover tablesorter table-estadisticas">
                                                <thead>
                                                    <tr>
                                                        <th width="20%">&nbsp;</th>
                                                        <th>Nombre</th>
