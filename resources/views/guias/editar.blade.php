                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/guias/{{ Auth::id() }}/editar">
                        ...
                        <div class="form-group{{ $errors->has('camNombre') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="camNombre" value="{{ $guia->camNombre }}" readonly />
                        ...
                        <div class="form-group{{ $errors->has('rolId') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="rolId">
                                        <option value="{{ $guia->rolId }}">{{ $guia->role->rolNombre }}</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('guiVersion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="guiVersion" value="{{ $version }}" readonly />
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-sign-in"></i> Editar guia
                                </button>
                            </div>
                        </div>
                    </form>
